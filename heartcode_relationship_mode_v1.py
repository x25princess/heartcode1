# -*- coding: utf-8 -*-
# HEARTCODE Simulation â€” Relationship Mode v1.0
# Simulates emotional dynamics between two entities: Alex and Riley
...
def setup_logging():
    ...
    log_txt_path = os.path.join(log_dir, f"heartcode_relationship_log_{timestamp}.txt")
    log_csv_path = os.path.join(log_dir, f"heartcode_relationship_log_{timestamp}.csv")
